  ...
  return (
    <>
      ...
      >
        ...
        {/* Collections Grid */}
        <main className="px-4 lg:px-8 pb-16" style={{ marginTop: "-10px" }}>
          {/* Desktop: 1800px container with 3 columns */}
          <div className="hidden lg:block">
            <div className="mx-auto" style={{ maxWidth: "1800px" }}>
              ...
              <div className="w-full flex justify-between items-center mb-1">
                ...
                <span className="text-sm font-medium text-gray-900" style={{ transform: "translateX(-10px)" }}>
                  122 RESULTS
                </span>
              </div>

              {/* Album Grid - 3 columns with calculated width */}
              <div className="grid grid-cols-3 gap-8">
                {collections.map((collection) => (
                  <div key={collection.id} className="group">
                    <Link href={collection.href}>
                      <div
                        className="relative overflow-hidden bg-gray-100 mb-3 transition-transform duration-300 group-hover:scale-105 cursor-pointer aspect-square"
